...
function FeatureA() {
    return (
        <div id="features" className='flex w-full h-fit'>
            <motion.div 
            ...
            <div className="flex flex-col w-full sm:w-[60%] px-8 sm:px-6 gap-y-2">
                ...
                <button className="text-[#c0fa49] border-2 border-[#c0fa49] hover:text-black text-lg px-6 py-2 bg-black hover:bg-[#c9fa49] w-fit rounded-full mt-10 transition-all duration-500 ease-in-out">
                    Get Started
                </button>
            </div>
