...
function Pricing() {
    return (
        <div className="w-full flex flex-col text-white gap-y-10 mb-20">
            <h1 className="text-5xl text-center" >Affordable Pricing</h1>
            ...
            className="flex flex-wrap w-full items-center justify-center gap-8 mt-8" >
                <div className="flex flex-col w-full sm:max-w-[400px] max-w-[350px] rounded-xl overflow-hidden border-2 border-[#c0fa49]/20 ">
                    ...
                    <button className="px-8 py-4 border-2 border-[#c0fa49] w-fit mx-auto mb-10 rounded-lg">Read More</button>
                </div>
